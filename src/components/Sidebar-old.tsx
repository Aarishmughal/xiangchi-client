...
function SideBar({ API_URL }: SidebarProps) {
    ...
    const handleTokenRefresh = useCallback(async () => {
        try {
            ...
            // If refresh successful, retry fetching user
    ...
    useEffect(() => {
        const fetchCurrentUser = async () => {
            try {
                ...
                // If token is invalid, try to refresh or clear cookies
                if (
    ...
    const handleLogout = async () => {
        try {
            ...
            // Always clean up cookies and state, then redirect
            clearAuthCookies();
